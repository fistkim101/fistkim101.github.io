...
- ~ 4.30
  - [ ] 1개 이상 서비스 출시 완료 (기간에 맞추기 위해 억지로 기능 축소를 하지말고 데드라인은 유동적으로 생각하자. 5월 초까지)
...
### 2023. 04. 17
- 오전
  - [ ] 인프런 쿠버네티스 강의 복습 CH 04 쿠버네티스 기본 실습
  - [ ] 인프라공방 과거 필기노트 내 도커 부분 옮기기(ch04 이후 추가로)
  - [ ] 월간 목표 점검 및 BM 우선순위 정리
  - [ ] BM 우선순위에 따른 개발 계획 수립(jira 사용 반드시)

- 오후
  - [ ] 헬스케어 관련 논문 최신순 검색
  - [ ] 디지털 헬스케어 의료의 미래 강독
  - [ ] 이메탈 rds 빼고 platform ec2 내에 docker 로 볼륨 연결해서 database 띄워서 그거 바라보게 처리
  - [ ] 개발 계획에 따라 향후 2 달 1주 혹은 2주 단위 마일스톤 수립(서비스 운영과 신규 서비스 출시, xyz 발굴 병렬진행 등)
...
### K8s 학습 순서
- [ ] docker 관련 예전에 정리한 포스팅 복습
- [ ] 인프런 K8s 강의 복습
- [ ] K8s 입문 도서 강독
- [ ] udemy MSA 강의 완강 (K8s 가 코어 내용)
- [ ] udemy docker, K8s 강의 완강
