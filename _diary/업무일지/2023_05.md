...
- [ ] 예전 깃블로그 포스팅에서 유의미한 포스팅 전부 이전 시키기
  - 필요시 현재 깃블로그 카테고리 추가 개편
...
- [ ] image uploader
- [ ] swagger
- [ ] [GRMC-9](https://fistkim.atlassian.net/browse/GRMC-9) 멀티모듈 템플릿 프로젝트 구현
- [ ] [GRMC-10](https://fistkim.atlassian.net/browse/GRMC-10) 프로젝트 초기 공통 작업
