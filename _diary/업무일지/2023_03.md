...
- 오전
  ...
  - [x] Flutter Advanced Course - Clean Architecture With MVVM CH 17 - Presentation Layer - MVVM - Home Flow(1h 18min) < -- 얼마 걸리나 보자 
  - [x] Flutter Advanced Course - Clean Architecture With MVVM CH 18 - Assignment - Refactor Home(9min)

- 오후
  - [ ] 아이디어 불패의 법칙 (정리) (화이트보드 한번 정리 하고 ppt 로 이미지 뜨는게 좋을 것 같다)
  - [ ] 린스타트업 (50%)
