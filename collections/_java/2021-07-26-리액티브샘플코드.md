---
layout: article
title: Reactive Streams 원리탐구 - 간단한 예제 직접 작성해보기
...
정말 간단한 예제인데, 결국 이러한 개념을 바탕으로 Publisher 와 Subscriber 가 동작하며 **<red>Reactor 는 필요한 모든 데이터 시퀀스에 대해서
이렇게 손으로 일일이 작성할 필요없이 알아서 Publisher <-> Subscriber 를 만들어주어서 우리가 편리하게 이를 사용할 수 있게 해주는
라이브러리라고 할 수 있다.</red>**
...
{% include image.html src="/assets/images/java/reactive-streams-flow.png" text="https://engineering.linecorp.com/ko/blog/reactive-streams-with-armeria-1/" %}
